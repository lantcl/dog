...
function forwardfunction(){
    ...
    var tomorrowRecord = new XMLHttpRequest();
        ...
        dateRequest = new Date(Date.parse(curDate) + 86400000);
        ...
        tomorrowRecord.send("testing=" + dateRequest);
...
function backfunction(){
    ...
    var yesterdayRecord = new XMLHttpRequest();
        ...
        function walkHistory(response) {
            ...
            var maxTime = 24;
            var time = parseInt(h / maxTime *100);  
            console.log(new Date(Date.parse(curDate) - 86400000));
        ...
        yesterdayRecord.send("testing=" + new Date(Date.parse(curDate) - 86400000));
